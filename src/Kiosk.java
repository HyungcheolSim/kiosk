...
public class Kiosk {
    ...
    public static void selectProduct(List<Product> catProduct,int selectCat) {
        ...
        for (int i = 0; i < catProduct.size(); i++) {
            ...
            if (i == num - 1) {
                //음료류가 아닐 떄만 옵션 선택
                if (selectCat<6&&selectCat!=5&&selectCat!=0&&selectCat!=2) {
    ...
    /*public static void init() {
        ...
        dataMap.put("Burgers", burgerList);
        dataMap.put("BurgerPacks", burgerPackList);
        dataMap.put("Salads", saladList);
        dataMap.put("Sides", sideList);
        dataMap.put("Beverage", beverageList);
